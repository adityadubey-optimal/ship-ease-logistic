...
export default function StepFlow({
    ...
    // Responsive sizes
    const iconSize = useResponsiveSize(20, 32)    // Icon: 20–32px
    const titleFontSize = useResponsiveSize(14, 18)
    const boxWidth = useResponsiveSize(150, 180)   // Fixed width (px)
    const boxHeight = useResponsiveSize(100, 120)   // Fixed height (px)
                        ...
                        >
                            ...
                            <span
                                style={{
                                    ...
                                    marginTop: "6px",
                                    textAlign: "center",
                                    fontSize: `${useResponsiveSize(0.55, 0.85)}rem`,
                                    color: "#444",
                                    fontWeight: 450
