...
import ShippingDetailsHeader from "./DetailPackingListSkuMobile"
import OrderHeader from "@/components/mobile/DataTableInfoSectionDetailPackingListMobile"
import { useTheme } from "@/context/ThemeContext"


export const DataTableForPoMobile = ({ showDetailedPackingList = false }: { showDetailedPackingList?: boolean }) => {
